...
test1 = TestCase ( assertEqual 
    ...
    True (ifExprCheck ifString (LiteralExpr  (StrLit "\"Merhaba\"") 0)) )

test2 :: Test
test2 = TestCase ( assertEqual 
    ("for if expression: " ++ ifString2)
    True (ifExprCheck ifString2 (LiteralExpr  (StrLit "\"Dunya\"") 0)) )

test3 :: Test
test3 = TestCase ( 
    assertEqual
    ("for if expression: " ++ ifBoolExpr1)
    True (ifExprCheck ifBoolExpr1 (LiteralExpr  (BLit False) 0)) 
    )
...
test4 = TestCase ( 
    ...
    True (ifExprCheck ifBoolExpr2 (LiteralExpr  (BLit True) 0))
    )
...
test5 = TestCase ( 
    ...
    True (ifExprCheck ifNumExpr1 (LiteralExpr  (NumLit 1.05) 0))
    )
...
test6 = TestCase ( 
    ...
    True (ifExprCheck ifNumExpr2 (LiteralExpr  (NumLit 0.5) 0))
    )
...
test7 = TestCase (
    ...
    True (ifExprCheck ifUnaryExpr1 (LiteralExpr  (BLit True) 0))
    )
...
test8 = TestCase (
    ...
    True (ifExprCheck ifUnaryExpr2 (LiteralExpr  (BLit False) 0))
    )
...
test9 = TestCase (
    ...
    True (ifExprCheck ifUnaryExpr3 (LiteralExpr  (NumLit (-1.0)) 0))
    )
...
test10 = TestCase (
    ...
    True (ifExprCheck ifUnaryExpr4 (LiteralExpr  (NumLit (-3.0)) 0))
    )
...
test11 = TestCase (
    ...
    True (ifExprCheck ifBinaryExpr1 (LiteralExpr  (NumLit (-4.0)) 0))
    )
...
test12 = TestCase (
    ...
    True (ifExprCheck ifBinaryExpr2 (LiteralExpr  (NumLit (9.0)) 0))
    )
...
test13 = TestCase (
    ...
    True (ifExprCheck ifIfExpr1 (LiteralExpr  (NumLit (9.0)) 0))
    )
...
test14 = TestCase (
    ...
    True (ifExprCheck ifIfExpr2 (LiteralExpr  (NumLit (2.0)) 0))
    )
